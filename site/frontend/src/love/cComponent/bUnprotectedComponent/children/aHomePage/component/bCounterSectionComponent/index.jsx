              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#234E70] dark:bg-[#FBF8BE] text-[#FBF8BE] dark:text-[#234E70] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#FBF8BE] dark:bg-[#234E70] text-[#234E70] dark:text-[#FBF8BE] flex-shrink-0">
