...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#FBF8BE]/60 dark:supports-[backdrop-filter]:bg-[#234E70]/60 text-[#234E70] dark:text-[#FBF8BE]">
